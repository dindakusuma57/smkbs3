    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
            ...
            <div class="lg:mx-auto text-left ">
                <h4 class="text-lg text-white font-medium mb-7">Pagedone</h4>
                <ul class="text-sm  transition-all duration-500">
                    <li class="mb-6"><a href="javascript:;"  class="text-white hover:text-gray-900">Home</a></li>
            ...
            <div class="lg:mx-auto text-left ">
                ...
                <ul class="text-sm  transition-all duration-500">
                    <li class="mb-6"><a href="javascript:;"  class="text-white hover:text-gray-900">Figma UI System</a></li>
                    <li class="mb-6"><a href="javascript:;"  class=" text-white hover:text-gray-900">Icons Assets</a></li>
                    <li class="mb-6"><a href="javascript:;"  class=" text-white hover:text-gray-900">Responsive Blocks</a></li>
        ...
        <div class="py-7 border-t border-gray-200">
            <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                ...
                <div class="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                    ...
                    <a href="https://www.instagram.com/smkbinasejahtera34"  class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-indigo-600">
                    ...
                    <a href="https://www.youtube.com/@smkbinasejahtera34"  class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-indigo-600">

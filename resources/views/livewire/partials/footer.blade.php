    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
            <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                ...
                <a href="/kontak"  class="py-2.5 px-5 h-9 block w-fit bg-[#C4DAD2] rounded-full shadow-sm text-xs text-[#116453] hover:text-white mx-auto transition-all duration-500 hover:bg-[#116453] lg:mx-0">
                    Kontak Kami
                </a>
            </div>
            <!--End Col-->
            ...
            <div class="lg:mx-auto text-left">
                ...
                <ul class="text-sm  transition-all duration-500">
                    ...
                    <li><a href="/kalender"  class=" text-white hover:text-gray-900">Kalender</a></li>
                </ul>
            </div>
        </div>
        <!--Grid-->
        <div class="py-7 border-t border-gray-200">
            <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                ...
                <div class="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                    ...
                    <a href="https://www.youtube.com/@smkbinasejahtera34"  class="w-9 h-9 rounded-full bg-[#C4DAD2] flex justify-center items-center hover:bg-indigo-600">
                        <svg class="w-[1.25rem] h-[0.875rem] text-[#16423C]" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">

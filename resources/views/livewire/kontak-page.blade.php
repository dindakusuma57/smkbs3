                ...
                <div style="margin-top:-140px; margin-bottom:-80px" data-aos="fade-up" class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-20 lg:px-8">
                    <div class="mt-16 lg:mt-20">
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <div class="bg-[#6A9C89] text-white rounded-sm p-6" style="border-radius: 0px 20px 20px 0px;">
            ...
            <div data-aos="fade-up" class="relative p-4 w-full max-w-md h-full md:h-auto">
                ...
                <div class="relative p-4 text-center bg-[#6A9C89] rounded-lg shadow ] sm:p-5">
                    ...
                    <div class="w-12 h-12 rounded-full bg-white p-2 flex items-center justify-center mx-auto mb-3.5">
                        <svg aria-hidden="true" class="w-8 h-8 text-[#6A9C89] " fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>

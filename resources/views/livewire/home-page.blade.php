...
<section class="bg-gradient-to-b from-[#116453] to-[#032830]" >
	<div class="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
		<div class="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left" data-aos="fade-in">
			...
			<div class="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
				<a rel="noopener noreferrer" href="#" class="px-8 py-3 text-lg font-semibold rounded bg-white dark:text-black">Suspendisse</a>
			</div>
		</div>
		<div class="flex items-center justify-center h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128" data-aos="zoom-out" data-aos-delay="100">
            <img src="img/hero1.png" alt="" class="object-contain h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
		</div>
	</div>
</section>
...
<div class="relative w-full bg-cover bg-center" style="background-image: url('img/landing2.jpeg');">
    ...
    <div class="relative max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8 lg:py-20">
        ...
        <dl class="mt-10 text-center sm:max-w-3xl sm:mx-auto sm:grid sm:grid-cols-4 sm:gap-8" data-aos="fade-up" data-aos-delay="100">
            <div class="flex flex-col">
              <dt class="order-2 mt-2 text-lg leading-6 font-medium text-white">Components</dt>
              <dd class="order-1 text-5xl font-extrabold text-white purecounter"
...
<section class="bg-white mt-10">
    <div class="half-green-card mx-auto max-w-[1340px] px-4 py-12 sm:px-6 lg:me-0 lg:py-16 lg:pe-0 lg:ps-8 xl:py-24">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:items-center lg:gap-16">
          <div class="max-w-xl text-left ltr:sm:text-left rtl:sm:text-right" data-aos="fade-up" data-aos-delay="100">
        ...
        <div id="keen-slider" class="keen-slider" data-aos="fade-left" data-aos-delay="100">
          ...
          {{-- Card 1 --}}
          <div class="keen-slider__slide">
            <blockquote class="rounded-xl flex h-full flex-col justify-between bg-[#FC7753] p-6 shadow-sm sm:p-8 lg:p-12">
              <div>
                <div class="mt-4">
                  <p class="mt-4 leading-relaxed text-white">
                    No, Rose, they are not breathing. And they have no arms or legs … Where are
...
<section class="py-4 px-4 bg-gray-50">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center flex-col lg:flex-row md:mt-20">
            ...
            <div class="w-full lg:w-1/2 lg:mt-0 md:mt-40 mt-16 max-lg:max-w-2xl" data-aos="zoom-in" data-aos-delay="100">

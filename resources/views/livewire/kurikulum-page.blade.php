...
<div>
    ...
    <section>
        ...
        <div class="max-w-6xl mt-8 mx-auto  text-center mb-10 lg:mb-20">
            ...
            <p data-aos="fade-up" class="font-medium sm:text-2xl text-[#16423C] mt-2 text-center text-base leading-7 inline-block border-b-4 border-[#6A9C89] pb-2">
                SMK Bina Sejahtera 3
            </p>
            <p data-aos="fade-up" data-aos-delay="50" class="font-medium text-[#16423C] mt-4 justify-center text-base text-justify">{{$kurikulum -> deskripsi}}
            </p>
        </div>
        @endforeach
    </section>

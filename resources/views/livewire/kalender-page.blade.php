<div>
        ...
        <div class="relative w-full bg-cover bg-center" style="background-image: url('img/landing2.jpeg');">
            ...
            <div
                ...
                <h3 class="mt-4 text-lg font-semibold">
                    <a href="#" class="text-white hover:underline">Profile</a> &gt; <span>Kalender Akademik</span>
                </h3>
            </div>
        </div>
    </section>
    ...
    <section class="relative bg-stone-50">
        <div
            class="bg-sky-400 w-full sm:w-40 h-40 rounded-full absolute top-1 opacity-20 max-sm:right-0 sm:left-56 z-0">
        </div>
                        ...
                        <div class="flex gap-5 flex-col">
                            <div class="p-6 rounded-xl bg-white">
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    <div class="dropdown relative inline-flex">
                                        <button type="button" data-target="dropdown-default"
                                ...
                                <p class="text-base font-normal text-gray-600">Meet-Up for Travel Destination Discussion
                                </p>
                            </div>
                            <div class="p-6 rounded-xl bg-white">
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    <div class="dropdown relative inline-flex">
                                        <button type="button" data-target="dropdown-a"
                            ...
                            <div class="p-6 rounded-xl bg-white">
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    <div class="dropdown relative inline-flex">
                                        <button type="button" data-target="dropdown-b"
                                ...
                                <p class="text-base font-normal text-gray-600">Discussion with developer for upcoming
                                    project</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="grid grid-cols-7 rounded-b-xl">
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <p class="hidden xl:block text-xs font-medium text-purple-600 mb-px">Meeting
                                        </p>
                                        <span
                                            class="hidden xl:block text-xs font-normal text-purple-600 whitespace-nowrap">10:00
                                            - 11:00</span>
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <p
                                            ...
                                            Developer Meetup</p>
                                        <span
                                            class="hidden xl:block text-xs font-normal text-emerald-600 whitespace-nowrap">10:00
                                            - 11:00</span>
                                ...
                                <div
                                    class="flex xl:aspect-square max-xl:min-h-[60px] p-3.5 bg-white border-b border-indigo-200 transition-all duration-300 hover:bg-indigo-50 cursor-pointer">
                                    <span
                                        class="text-xs font-semibold text-indigo-600 sm:text-white sm:w-6 sm:h-6 rounded-full sm:flex items-center justify-center sm:bg-indigo-600">9</span>
                                </div>
                                <div
                                    class="flex xl:aspect-square max-xl:min-h-[60px] p-3.5 bg-white border-r border-b border-indigo-200 transition-all duration-300 hover:bg-indigo-50 cursor-pointer">
                                ...
                                <div
                                    ...
                                    <div
                                        class="absolute top-9 bottom-1 left-3.5 p-1.5 xl:px-2.5 h-max rounded bg-sky-50 ">
                                        <p
                                            class="hidden xl:block text-xs font-medium text-sky-600 mb-px whitespace-nowrap">
                                            Developer Meetup</p>
                                        <span
                                            class="hidden xl:block text-xs font-normal text-sky-600 whitespace-nowrap">10:00
                                            - 11:00</span>
                                ...
                                <div
                                    ...
                                    <div
                                        class="absolute top-9 bottom-1 left-3.5 p-1.5 xl:px-2.5 h-max rounded bg-purple-50 ">
                                        <p
                                            class="hidden xl:block text-xs font-medium text-purple-600 mb-px whitespace-nowrap">
                                            Friends Meet</p>
                                        <span
                                            class="hidden xl:block text-xs font-normal text-purple-600 whitespace-nowrap">09:00
                                            - 13:42</span>
                                        <p class="xl:hidden w-2 h-2 rounded-full bg-purple-600"></p>
                                    </div>
                                </div>

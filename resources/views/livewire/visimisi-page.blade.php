        ...
        <div class="relative w-full bg-cover bg-center" style="background-image: url('img/landing2.jpeg');">
            ...
            <div
                ...
                <h3 class="mt-4 text-lg font-semibold">
                    <a class="text-white hover:underline">Profil</a> &gt; <span>Visi Misi</span>
                </h3>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
                <div class="max-w-lg">
                    @foreach ($visis as $visi)
                        ...
                        <p class="sm:text-4xl text-[#16423C] font-medium mt-4" data-aos="fade-up">SMK Bina Sejahtera 3
                        </p>
                        <p class="text-justify mt-4 mx-2 text-[#16423C] text-lg border-l-4 border-[#6A9C89] pl-4"
                ...
                <div class="mt-12 md:mt-0" data-aos="zoom-out" data-aos-delay="200">
                    <img src="{{ $visi ? asset('storage/' . $visi->image) : '' }}" alt="About Us Image"
                        class="object-cover h-auto max-h-80 w-full rounded-lg shadow-md transition-transform transform hover:scale-105 hover:shadow-lg">
                    @endforeach
                </div>
            </div>
        </div>
                ...
                <ul class="mt-16 grid grid-cols-1 gap-6 text-center text-slate-700 md:grid-cols-3">
                    @foreach ($misis as $misi)
                        <li data-aos="flip-left" data-aos-delay="100"
                            class="rounded-xl bg-white hover:bg-[rgba(205,213,210,0.7)] px-6 py-8 shadow-sm hover:shadow-lg hover:scale-105 transition-transform duration-200">
                            <div class="flex justify-center mb-1">
                                <img src="{{ $misi ? asset('storage/' . $misi->image) : '' }}" alt="Lock Icon"
                    ...
                    <div class="flex flex-col mb-10 w-3/4 ">
                        <div class="w-full mb-5 sm:mb-0  ">
                            <div data-aos="fade-up-left"
                                class="relative h-full ml-0 mr-0 sm:mr-10 hover:shadow-lg hover:scale-105 transition-transform duration-200">
                                <span
                                    class="absolute top-0 left-0 w-full h-full mt-1 ml-1 bg-[#C4DAD2] rounded-lg"></span>
                                <div class="relative h-full p-5 bg-[#C4DAD2]  rounded-lg">
                                    <p class="text-justify mb-2 text-[#16423C] border-l-4 border-[#6A9C89] pl-4">
                                        {{ $tujuan->deskripsi }}
                                    </p>
                                </div>
                            </div>

...
<section>
    <div class="py-12 md:px-20 sm:px-14 px-6">
        <h1 class="text-3xl font-extrabold text-[#16423C] sm:text-4xl flex items-center justify-between" data-aos="fade-up">
            Berita
            <div class="flex space-x-2">
                <span class="bg-[#C4DAD2] text-[#002500] text-sm font-semibold px-3 py-1 rounded-full hover:bg-[#16423C] hover:text-white">Semua</span>
                <span class="bg-[#C4DAD2] text-[#002500] text-sm font-semibold px-3 py-1 rounded-full hover:bg-[#16423C] hover:text-white">Keagamaan</span>
                <span class="bg-[#C4DAD2] text-[#002500] text-sm font-semibold px-3 py-1 rounded-full hover:bg-[#16423C] hover:text-white">Berita</span>
                <span class="bg-[#C4DAD2] text-[#002500] text-sm font-semibold px-3 py-1 rounded-full hover:bg-[#16423C] hover:text-white">Prestasi</span>
                <span class="bg-[#C4DAD2] text-[#002500] text-sm font-semibold px-3 py-1 rounded-full hover:bg-[#16423C] hover:text-white">Ekstrakulikuler</span>
            </div>
        </h1>
